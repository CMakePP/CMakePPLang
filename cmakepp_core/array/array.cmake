...
include(cmakepp_core/array/detail_/copy)
...
include(cmakepp_core/array/detail_/print)
...
macro(cpp_array _ca_mode)
    ...
    elseif("${__ca_mode}" STREQUAL AS_LIST)
        _cpp_array_as_list(${ARGN})
    elseif("${__ca_mode}" STREQUAL BACK)
        _cpp_array_back(${ARGN})
    elseif("${__ca_mode}" STREQUAL COPY)
        _cpp_array_copy(${ARGN})
    ...
    elseif("${__ca_mode}" STREQUAL PRINT)
        _cpp_array_print(${ARGN})
