...
ct_add_test("_cpp_is_path")
    ...
    ct_add_section("array")
        ...
        _cpp_is_path(result "${my_array}")
        ct_assert_equal(result FALSE)
    ct_end_section()

    ct_add_section("bool")
        _cpp_is_path(return TRUE)
    ...
    ct_add_section("description")
        ...
        ct_add_section("Normal description")
            _cpp_is_path(return "Hello World")
            ct_assert_equal(return FALSE)
        ct_end_section()

        ct_add_section("Description with a filepath in it")
            _cpp_is_path(return "The path is: ${CMAKE_CURRENT_LIST_DIR}")
            ct_assert_equal(return FALSE)
        ct_end_section()
    ct_end_section()

    ct_add_section("float")
        _cpp_is_path(return 3.14)
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("integer")
        _cpp_is_path(return 42)
        ct_assert_equal(return FALSE)
    ct_end_section()
    ...
    ct_add_section("obj")
        ...
        _cpp_is_path(result "${an_object}")
        ct_assert_equal(result FALSE)
    ct_end_section()

    ct_add_section("path")
        ct_add_section("absolute")
            _cpp_is_path(return "${CMAKE_BINARY_DIR}")
            ct_assert_equal(return TRUE)
        ct_end_section()

        ct_add_section("relative")
            _cpp_is_path(return "a/directory")
            ct_assert_equal(return FALSE)
        ct_end_section()
    ct_end_section()
    ...
    ct_add_section("target")
        ...
        _cpp_is_path(return lib)
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("type")
        _cpp_is_path(return bool)
        ct_assert_equal(return FALSE)
    ct_end_section()
