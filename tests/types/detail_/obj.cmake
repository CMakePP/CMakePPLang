...
ct_add_test("_cpp_is_obj")
    ...
    ct_add_section("array")
        ...
        _cpp_is_obj(result "${my_array}")
        ct_assert_equal(result FALSE)
    ct_end_section()

    ct_add_section("bool")
        _cpp_is_obj(return TRUE)
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("description")
        _cpp_is_obj(return "Hello World")
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("float")
        _cpp_is_obj(return 3.14)
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("integer")
        _cpp_is_obj(return 42)
        ct_assert_equal(return FALSE)
    ct_end_section()
    ...
    ct_add_section("list")
        ...
        ct_add_section("List of objects")
            _cpp_object_ctor(my_obj)
            _cpp_is_obj(return "${my_obj};${my_obj}")
            ct_assert_equal(return FALSE)
        ct_end_section()
    ct_end_section()
    ...
    ct_add_section("map")
        ...
        _cpp_is_obj(result "${my_map}")
        ct_assert_equal(result FALSE)
    ct_end_section()

    ct_add_section("obj")
        _cpp_object_ctor(an_object)
        _cpp_is_obj(result "${an_object}")
        ct_assert_equal(result TRUE)
    ct_end_section()

    ct_add_section("path")
        _cpp_is_obj(return "${CMAKE_CURRENT_LIST_DIR}")
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("target")
        add_library(lib STATIC IMPORTED)
        _cpp_is_obj(return lib)
        ct_assert_equal(return FALSE)
    ct_end_section()

    ct_add_section("type")
        _cpp_is_obj(return bool)
        ct_assert_equal(return FALSE)
    ct_end_section()
ct_end_test()
