...
cpp_class(Automobile)
    ...
    function("${_cpp_object_equal}" self _oe_result _oe_other)
        ...
        Automobile(GET "${self}" _oe_color color)
        Automobile(GET "${_oe_other}" _oe_other_color color)

        if("${_oe_color}" STREQUAL "${_oe_other_color}")
            set("${_oe_result}" TRUE)
        else()
...
function("${overriding_object_methods}")
    ...
    function("${override_serialize}")
        ...
        cpp_serialize("${auto_1}" serialize_result)
