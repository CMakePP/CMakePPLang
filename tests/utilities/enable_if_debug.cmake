...
ct_add_test("cpp_enable_if_debug")
    ...
    ct_add_section("Signature")
        ...
        ct_assert_fails_as("cpp_enable_if_debug accepts no arguments.")
    ct_end_section()

    ct_add_section("Typical use-case")
        ...
        ct_add_section("CMAKEPP_CORE_DEBUG_MODE not set leaves IS_DEBUG alone")
            test_enable_if_debug()
            ct_assert_equal(IS_DEBUG FALSE)
        ct_end_section()

        ct_add_section("CMAKEPP_CORE_DEBUG_MODE==FALSE leaves IS_DEBUG alone")
            set(CMAKEPP_CORE_DEBUG_MODE FALSE)
            test_enable_if_debug()
            ct_assert_equal(IS_DEBUG FALSE)
        ct_end_section()

        ct_add_section("CMAKEPP_CORE_DEBUG_MODE==TRUE changes IS_DEBUG")
