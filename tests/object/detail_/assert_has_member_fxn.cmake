...
ct_add_test("_cpp_object_assert_has_member_fxn")
    ...
    ct_add_section("Signature")
        ...
        ct_add_section("Arg1 must be an obj")
            _cpp_object_assert_has_member_fxn(TRUE a_fxn)
            ct_assert_fails_as("Assertion: TRUE is obj")
        ct_end_section()

        ct_add_section("Arg2 must be a description")
            _cpp_object_assert_has_member_fxn("${an_object}" TRUE)
            ct_assert_fails_as("Assertion: TRUE is desc")
        ct_end_section()

        ct_add_section("Can not pass extra args")
            _cpp_object_assert_has_member_fxn("${an_object}" a_fxn hello)
